...
train = dict(
    exp_name='resnet18_tusimple_aug1b_large_kernel_attn_change_dialated',
    workers=8,
    batch_size=20,
    checkpoint=None,
    # Device args
...
test = dict(
    ...
    workers=0,
    batch_size=1,
    checkpoint='./checkpoints/resnet18_tusimple_aug1b_large_kernel_attn_change_dialated/model.pt',
    # Device args
    device='cuda',
