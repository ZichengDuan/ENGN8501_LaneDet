...
train = dict(
    exp_name='resnet18_bezierlanenet_tusimple-aug3',
    workers=8,
    batch_size=20,
    checkpoint='checkpoints/resnet18_bezierlanenet_tusimple-aug3/latest.pt',
    # Device args
    world_size=0,
    dist_url='env://',
    device='cuda',
...
test = dict(
    ...
    workers=0,
    batch_size=1,
    checkpoint='./checkpoints/resnet18_bezierlanenet_tusimple-aug3/model.pt',
    # Device args
    device='cuda',
