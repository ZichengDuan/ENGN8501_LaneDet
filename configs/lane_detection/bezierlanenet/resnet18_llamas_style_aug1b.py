...
with import_from('./'):
    # Data pipeline
    from configs.lane_detection.common.datasets.llamas_bezier_style import dataset
    from configs.lane_detection.common.datasets.train_level1b_transfer import train_augmentation
...
train = dict(
    exp_name='resnet18_bezierlanenet-triple-winter_llamas',
    workers=10,
    batch_size=18,
    checkpoint=None,
    # Device args
...
test = dict(
    ...
    workers=0,
    batch_size=1,
    checkpoint='./checkpoints/resnet18_bezierlanenet-triple-winter_llamas/model.pt',
    # Device args
    device='cuda',
