...
with import_from('./'):
    ...
    from configs.lane_detection.common.optims.adamw00006_dcn import optimizer
    from configs.lane_detection.common.optims.ep20_cosine import lr_scheduler


train = dict(
    exp_name='resnet18_bezierlanenet-aug2-mask-adamw_llamas',
    workers=10,
    batch_size=20,
    checkpoint=None,
    # Device args
...
test = dict(
    ...
    workers=0,
    batch_size=1,
    checkpoint='./checkpoints/resnet18_bezierlanenet-aug2-mask-adamw_llamas/model.pt',
    # Device args
    device='cuda',
