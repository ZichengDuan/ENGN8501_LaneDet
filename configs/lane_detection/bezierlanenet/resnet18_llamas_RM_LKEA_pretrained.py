...
with import_from('./'):
    ...
    from configs.lane_detection.common.datasets.train_level1b_360_RM import train_augmentation
...
train = dict(
    exp_name='resnet18_bezierlanenet_llamas_RM_LKEA_pretrained',
    workers=10,
    batch_size=20,
    checkpoint=None,
    # Device args
...
test = dict(
    exp_name='resnet18_bezierlanenet_llamas_RM_LKEA',
    workers=0,
    batch_size=1,
    checkpoint='./checkpoints/resnet18_bezierlanenet_llamas_RM_LKEA_pretrained_pretrained/model.pt',
    # Device args
    device='cuda',
