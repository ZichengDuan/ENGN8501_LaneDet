...
with import_from('./'):
    ...
    from configs.lane_detection.common.datasets.train_level1b_288_RM import train_augmentation
...
train = dict(
    exp_name='resnet18_bezierlanenet_culane_RM_LKEA',
    workers=10,
    batch_size=20,
    checkpoint=None,
    # Device args
...
test = dict(
    ...
    workers=0,
    batch_size=1,
    checkpoint='./checkpoints/resnet18_bezierlanenet_culane_RM_LKEA/model.pt',
    # Device args
    device='cuda',
